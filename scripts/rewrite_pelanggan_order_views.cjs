...
const index = path.join(base, 'resources', 'views', 'pelanggan', 'orders', 'index.blade.php');
const show = path.join(base, 'resources', 'views', 'pelanggan', 'orders', 'show.blade.php');

const indexContent = `@extends('layouts.pelanggan')
...
const showContent = `@extends('layouts.pelanggan')
...
fs.writeFileSync(show, showContent, 'utf8');
console.log('Pelanggan order views updated');
