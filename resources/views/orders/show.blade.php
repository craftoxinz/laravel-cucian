...
<a href="{{ route('orders.nota', $order) }}" target="_blank" class="btn btn-outline-secondary d-flex align-items-center gap-1" style="border-radius: 6px;">
      ...
      <div class="card-body p-0">
        ...
        <div class="p-3 border-bottom">
          ...
          <div class="row align-items-center mb-2">
            ...
            <div class="col-7 text-heading"><span class="badge bg-muted-lt text-secondary">{{ $order->user->name }}</span></div>
          </div>
          <div class="row align-items-center mb-2">
        ...
        <div class="p-3 bg-muted-lt">
          <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <span class="badge bg-{{ $order->status_badge }}-lt text-{{ $order->status_badge }} rounded-pill px-2.5 py-1 text-capitalize">{{ $order->status_label }}</span>
          </div>
          <div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        <form action="{{ route('orders.updateStatus', $order) }}" method="POST" id="formUpdateStatus">
          ...
          <button type="submit" class="btn btn-info w-100 d-flex align-items-center justify-content-center gap-1" style="border-radius: 6px;">
    ...
    <div class="card border-success">
      ...
      <div class="card-body">
        <form action="{{ route('orders.bayar', $order) }}" method="POST" id="formBayar">
          ...
          <div class="mb-3">
            ...
            <div class="d-flex gap-3 mt-1">
              <label class="form-check m-0">
                <input type="radio" name="metode_bayar" class="form-check-input" value="tunai" checked style="cursor: pointer;">
                <span class="form-check-label text-heading" style="cursor: pointer;">
                  <i class="ti ti-cash me-0.5 text-success"></i> Tunai
                </span>
              </label>
              <label class="form-check m-0">
                <input type="radio" name="metode_bayar" class="form-check-input" value="transfer" style="cursor: pointer;">
                <span class="form-check-label text-heading" style="cursor: pointer;">
          ...
          <button type="submit" class="btn btn-success w-100 d-flex align-items-center justify-content-center gap-1" style="border-radius: 6px;">
        ...
        <table class="table table-vcenter card-table text-nowrap">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-end text-secondary">Rp {{ number_format($item->harga, 0, ',', '.') }}</td>
              <td class="text-end font-weight-medium text-heading">Rp {{ number_format($item->subtotal, 0, ',', '.') }}</td>
            </tr>
            @endforeach
          </tbody>
          <tfoot>
