                           ...
                           data-bs-toggle="dropdown">
                            ...
                            <div>
                                <div class="text-white fw-medium small text-truncate"
                                     style="max-width: 130px;">{{ auth('pelanggan')->user()->nama }}</div>
                                <div class="mt-1 small text-white-50"
                                     style="font-size: 11px;">{{ auth('pelanggan')->user()->is_member ? 'Member' : 'Pelanggan' }}</div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            <div class="dropdown-header">
                        ...
                        @hasSection('breadcrumb')
                            <div class="mb-1">
                                <ol class="breadcrumb breadcrumb-arrows" aria-label="breadcrumbs">
                                    <li class="breadcrumb-item"><a href="{{ route('pelanggan.dashboard') }}">Home</a>
                                    </li>
                                    @yield('breadcrumb')
                                </ol>
                            </div>
