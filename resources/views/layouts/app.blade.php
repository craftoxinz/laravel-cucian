        ...
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pelanggan.*') ? 'active' : '' }}" href="{{ route('pelanggan.index') }}">
              <span class="nav-link-icon"><i class="ti ti-users fs-2"></i></span>
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('layanan.*') ? 'active' : '' }}" href="{{ route('layanan.index') }}">
              <span class="nav-link-icon"><i class="ti ti-shirt fs-2"></i></span>
              <span class="nav-link-title">Layanan & Harga</span>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('users.*') ? 'active' : '' }}" href="{{ route('users.index') }}">
              <span class="nav-link-icon"><i class="ti ti-user-cog fs-2"></i></span>
